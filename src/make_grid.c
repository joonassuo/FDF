...
/*   Updated: 2020/01/20 18:37:55 by jsuonper         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int                 ***make_3d_array(int fd, int *size)
{
    ...
    while (i < size[0])
    {
        ...
        while (j < size[1])
        {
            ...
            coords_array[i][j][0] = j * GRID_SZ;
            coords_array[i][j][1] = i * GRID_SZ;
...
void            draw_square(t_mlx_struct *mlx_ptr, int ***coords_arr, int x, int y)
{
    draw_line(
        coords_arr[y][x][0],
        coords_arr[y][x][1],
